    ...
    return (
        <div>
            ...
            <div className="p-6 bg-white1 dark:bg-black2 min-h-screen">
                <h1 className="text-2xl font-semibold text-black dark:text-white">Accepted Orders List</h1>
                        ...
                        <ul className="space-y-4">
                            {orders.map((order) => (
                                <li
                                    ...
                                    onClick={() => navigate(`/admin/portofolio/${order.id}`)}//route to the new page
                                >
...
export default AdminManagePorto;
